...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO wh_entries (Show_ID, Rider_Num, Rider_ID, Horse_ID, Horse_Pony, Class_01, Class_02, Class_03, Class_04, Class_05, Class_06, Class_07, Class_08, Class_09, Class_10, Class_11, Class_12, Class_13, Class_14, Class_15, Class_16, Class_17, Class_18, Class_19, Class_20, Ent_Paid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<table width="100%" border="0">
      ...
      <td width="100%"><form id="ad_ent" name="jsheet" method="Post" action="Juding_Sheet_WH.php?s=<?php echo $show_id; ?>" target="_blank">
