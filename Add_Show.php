...
<table width="100%" border="0">
      ...
      <td align="center" width="33%" valign="bottom"><h1>Add Show </h1>&nbsp;</td>
      <td width="33%"></td>
      </tr>
      </table>
<p>&nbsp;</p>
...
<table width="800" border="1" align="center">
    <tr>
      <td class="tabe1"  bgcolor="#7E7E7E" ><input type="text" name="show_name" width="40"> Show Name &nbsp;</td>
      <td class="tabe1" bgcolor="#7E7E7E"><input type="date" name="Show_Date" width="40"> Show Date &nbsp;</td>
      <td class="tabe1" bgcolor="#7E7E7E">
      <select name="Show_Type">
    
    <?php do { ?>
		    <?php echo '<option value="'.$row_Show_Type['Show_Type'].'">'.$row_Show_Type['Show_Type'].'</option>'; ?>
           <?php } while($row_Show_Type = mysql_fetch_assoc($Show_Type)) ;?>
		
        
</select> 
 </td>
      <td class="tabe1" bgcolor="#7E7E7E"><input type="submit" value="Add Show" />
    </tr>
</table>
