...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO rd_entries (Show_ID, Rider_Num, Rider_ID, Horse_ID, Horse_Pony, Class_01, Class_02, Class_03, Class_04, Class_05, Class_06, Class_07, Class_08, Class_09, Class_10, Class_11, Class_12, Class_13, Class_14, Class_15, Class_16, Class_17, Class_18, Class_19, Class_20, Class_21, Ent_Paid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<table width="100%" border="0">
      ...
      <td width="100%"><form id="ad_ent" name="jsheet" method="Post" action="Juding_Sheet_RD.php?s=<?php echo $show_id; ?>" target="_blank">
      ...
      <?php if (!empty($row_ihcls['C20'])){ echo '<option value="Class_20"> Class ';echo $row_ihcls['C20']; echo '</option>';}?>
            <?php if (!empty($row_ihcls['C21'])){ echo '<option value="Class_21"> Class ';echo $row_ihcls['C21']; echo '</option>';}?>
  ...
  <th nowrap="nowrap" width="30" >to Pay</th>
    ...
    <tr bgcolor="#B8B8B8">
      ...
      <?php if (!empty($row_ihcls['C20'])){ echo '<td ><input type="checkbox" name="Class_20" value="checked" size="4" /></td>'; }?>
            <?php if (!empty($row_ihcls['C21'])){ echo '<td ><input type="checkbox" name="Class_21" value="checked" size="4" /></td>'; }?>
