...
<html>
<head>
<meta http-equiv="refresh" content="<?php echo $sec?>;URL='showingRET.PHP?s=<?php echo $show_id;?>'">
<meta charset="UTF-8">
...
$totalRows_Entries = mysql_num_rows($Entries); ?>
  ...
  ?>
      ...
      <tr>
      <td bgcolor="#8D1100"> <form id="del" action="delentih1.php" method="get">
      ...
      <form action="update_entry_ih1.php" method="get">
...
$totalRows_Entries = mysql_num_rows($Entries); ?>
  ...
  ?>
      ...
      <tr>
      <td bgcolor="#8D1100"> <form id="del" action="delentrd1.php" method="get">
      		<input type="hidden" name="entrowid" value="<?php echo $row_Entries['id'];?>" />
            <input type="hidden" name="showdelid" value="<?php echo $show_id ;?>" />
      		<input id="delsub" type="submit"  onclick="clicked()" value="DELETE" />
            </form>
      <form action="update_entry_rd1.php" method="get">
      <input type="hidden" name="showid" value="<?php echo $show_id ; ?>" />
      <input type="hidden" name="entid" value="<?php echo $row_Entries['id'];?>" />
      <td ><?php echo $row_Entries['Rider_Num']; ?></td>
      <td><?php echo $row_Entries['Rider_ID']; ?></td>
...
$totalRows_Entries = mysql_num_rows($Entries); ?>
  ...
  ?>
      ...
      <tr>
      <td bgcolor="#8D1100"> <form id="del" action="delentwh1.php" method="get">
      		<input type="hidden" name="entrowid" value="<?php echo $row_Entries['id'];?>" />
            <input type="hidden" name="showdelid" value="<?php echo $show_id ;?>" />
      		<input id="delsub" type="submit"  onclick="clicked()" value="DELETE" />
            </form>
      <form action="update_entry_wh1.php" method="get">
      <input type="hidden" name="showid" value="<?php echo $show_id ; ?>" />
      <input type="hidden" name="entid" value="<?php echo $row_Entries['id'];?>" />
      <td ><?php echo $row_Entries['Rider_Num']; ?></td>
      <td><?php echo $row_Entries['Rider_ID']; ?></td>
